...
config_flag = 'regression_SO1_PR_phnfeats_750msdelays' # Todo consider no phnfeats for single subject
loo_config_flags = ['regression_justPhonetic_750msdelays',
                        'regression_SO1_PR_750msdelays']
irrr_flag = 'iRRR_small_lambda_210122'
col_ctr_RR = True
...
bash_path = None #op.join(config['local_timit_dir'],'bash','submit_cv_job.sh')
